...
export const HCQHA_RULES = [
  ...
  "Competitors that are not members of AQHA must be HCQHA members or temporary day members.",
  "Competitors compete at their own risk.",
  "Only competitors and officials permitted in ring when show in progress.",
  ...
  "No refunds of entry fees unless a vet certificate.",
...
export const BEGINNER_RULES = [
  ...
  "Can ride any-handed.",
  "Competitors must nominate as either Beginner OR Improver and cannot compete in both divisions at the same show.",
];

export const IMPROVER_RULES = [
  "Must not have won any performance event at A, AA, State or National shows.",
  "Must not have won a High Point Improver Award.",
  "Cannot compete on colts or stallions.",
  "Improver classes will include lope or canter.",
  "Can ride any-handed.",
  "Competitors must nominate as either Beginner OR Improver and cannot compete in both divisions at the same show.",
];
